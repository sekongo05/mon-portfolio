...
let Competence = ()=>{
    ...
    return <>
            ...
            <div  className='w-[100%] h-min sm:h-[min] flex flex-col  border-yellow-300  bg-white dark:bg-black '>
                <div  data-aos="fade-up"data-aos-anchor-placement="center-bottom" className='h-[100px] sm:h-[150px]  border-green-700 w-[100%] text-black dark:text-white flex justify-center items-center bg-white dark:bg-black'>
                ...
                <div className='gap-4 hidden border-red-500 w-full h-min sm:flex flex-col items-center text-black dark:text-white  bg-white dark:bg-black '>
                    ...
                    <div data-aos="fade-up"data-aos-anchor-placement="center-bottom" className=' mb-[20px]  w-full h-1/2 flex justify-between items-center sm:w-[90%] '>
                    ...
                    <div data-aos="fade-left" data-aos-offset="300"    data-aos-easing="ease-in-sine" className='  w-full h-1/2 flex justify-between items-center sm:w-[80%]'>
                    ...
                    <div   data-aos="fade-right" data-aos-offset="300"    data-aos-easing="ease-in-sine "className=' h-1/2 flex justify-between items-center sm:w-[80%]'>
                        <p className='w-[200px] h-[250px]  flex flex-col logo'>
